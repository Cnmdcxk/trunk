package netplus.joint.erp.in.service;
...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("netplus.joint.erp.in.service.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("YG_JOINT_ERP_IN_API")  //粗标题
                .version("1.0.0")   //api version
                .termsOfServiceUrl("http://localhost:20033/doc.html")
                .license("LICENSE")   //链接名称
                .licenseUrl("http://localhost:20033/doc.html")   //链接地址
                .build();
    }
}
