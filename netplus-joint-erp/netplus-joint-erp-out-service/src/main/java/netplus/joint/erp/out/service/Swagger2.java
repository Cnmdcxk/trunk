...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("netplus.joint.erp.out.service.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("YG_JOINT_ERP_OUT_API")  //粗标题
                .version("1.0.0")   //api version
                .termsOfServiceUrl("http://localhost:20034/doc.html")
                .license("LICENSE")   //链接名称
                .licenseUrl("http://localhost:20034/doc.html")   //链接地址
                .build();
    }
}
