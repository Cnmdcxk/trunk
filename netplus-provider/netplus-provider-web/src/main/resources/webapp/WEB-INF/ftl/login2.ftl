            ...
            <div class="w1200">
                <div class="logo_img">
                    <img src="${cdn}/img/logo/logo_000.png" onclick="javascript:location.href='/'"
                         style="cursor: pointer;height: 50px;" alt="" class="fl" height="36">
                </div>
            </div>
        </div>
        <!-- 背景大块 -->
        <div class="login_bg">
            <div class="login_box">
                <div class="login_item">
                    <div class="tc f18">
                        <span class="c_blue">供应商登录</span>
                        <i>/</i>
                        <span><a href="/provider/login">员工登录</a></span>
...
<@override name="js">
    ...
    <script type="text/javascript" src="${cdn}/js/provider/login.js?v=${ver!}"></script>
</@override>
