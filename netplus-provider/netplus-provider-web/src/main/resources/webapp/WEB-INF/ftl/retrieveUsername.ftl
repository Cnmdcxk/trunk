<@override name="title">找回账号-验证身份</@override>
            ...
            <div class="w1200 bg_fff">
                ...
                <div class="w550 margin pt80 lh40">
                    <el-form :model="form"
                        ...
                        <el-form-item prop="phone" label="注册手机号码：">
                                    ...
                                    _this.validateCode().then((msg) => {
                                        ...
                                        ajax('/api/provider/sendSmsCode/',
                                            ...
                                            function (resp) {
                                                // 发送成功
                                                if (resp.status == 1) {
                                                    _this.sessionId = resp.data.sessionId;
                                                    const TIME_COUNT = 60;
                                                    if (!_this.timer) {
                        ...
                        if (valid) {
                            ...
                            _this.validateCode().then((msg) => {
                                ajax('/api/provider/retrieve/',
                                    ...
                                    function (resp) {
                                        if (resp.status == 1) {
                                            let sid = _this.sessionId;
                                            setTimeout(function () {
                                                window.location.href = '/provider/retrieveUsername2/?sessionId=' + sid;
                                            }, 10)
                                        } else {
                                            let errMsg = resp.msg;
                                            if (errMsg.includes("，")) {
