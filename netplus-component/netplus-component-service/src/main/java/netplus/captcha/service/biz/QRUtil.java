...
public class QRUtil {
    ...
    private static BufferedImage createImage(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        // 插入图片
        QRUtil.insertImage(image, imgPath, needCompress);
        return image;
    }
    ...
    public String encode(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
        ...
        MultipartFile multipartFile = new MockMultipartFile(
                ...
                in);
        logger.info("enter");
        UploadResult uploadResult = fileUploadRest.doUpload(multipartFile);
        logger.info("uploadResult===>" + BasedController.gson.toJson(uploadResult));
