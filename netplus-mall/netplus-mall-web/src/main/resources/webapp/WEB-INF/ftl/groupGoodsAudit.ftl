<@override name="title">商品审核</@override>
        ...
        <div class="mt5">
            <div class="bd_t_dedede">
                <ul class="menu_right supplier_menu">
                    <li class="curr" style="cursor: pointer">待我审核（{{needMyCount}}）</li>
                    <li><a href="/mall/groupMyGoodsAudit" style="cursor: pointer">全部（{{myCount}}）</a></li>
                </ul>
                <div class="p10">
                    <!-- 筛选 -->
                    <frame-filter
...
<@override name="js">
    ...
    <script type="text/babel" src="${cdn}/js/mall/groupGoodsAudit.js?ver=${ver!}"></script>
</@override>
