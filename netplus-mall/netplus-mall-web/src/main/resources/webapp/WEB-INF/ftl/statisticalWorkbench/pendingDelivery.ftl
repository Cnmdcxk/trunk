                ...
                <div class="bd_t_dedede">
                    ...
                    <div class="p10">
                        ...
                        <el-table
                            ...
                            <el-table-column prop="orderdetailno" label="项次号"></el-table-column>
                            ...
                            <el-table-column label="供应商接单日期">
                                <template slot-scope="scope">
                                    {{scope.row.receivingdate|strDateFormat}}
                                </template>
                            </el-table-column>
...
<@override name="js">
    <script type="text/babel" src="${cdn}/js/mall/pendingDelivery.js?ver=${ver!}"></script>
</@override>
