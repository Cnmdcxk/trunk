                ...
                <div class="p10">
                    ...
                    <div class="pr">
                        ...
                        >
                            ...
                            <el-table-column  prop="pono" label="合同编号" ></el-table-column>
                            <el-table-column  prop="matrltm" label="合同有效期" >
                                <template slot-scope="scope">
                                    <div>{{scope.row.popricestartdate | strDateFormat }}</div>
                                    <div>{{scope.row.popricedate | strDateFormat }}</div>
                                </template>
                            </el-table-column>
                            <el-table-column  prop="matrltm" label="物资条码" ></el-table-column>
                            <el-table-column  prop="matrlno" label="物资编码" ></el-table-column>
                            ...
                            <el-table-column  prop="date" label="单价" >
                                <template slot-scope="scope">
                                    <div class="f14 fb c_red">¥{{scope.row.price}}</div>
                                </template>
                            </el-table-column>
...
<@override name="js">
    <script type="text/babel" src="${cdn}/js/mall/unlistedGoods.js?ver=${ver!}"></script>
</@override>
