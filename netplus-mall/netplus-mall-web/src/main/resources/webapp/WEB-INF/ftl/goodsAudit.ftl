<@override name="title">商品上架确认</@override>
    ...
    <div class="w1200">
        ...
        <div class="right_con" id="RZ" v-cloak>
            <div class="right_top">
                ...
                <span class="c_blue fl ml10">商品上架确认</span>
            </div>
            <div class="mt5">
                <div class="bd_t_dedede">
                    <div class="p10">
                        ...
                        <div class="tr clear pb20 lh25">
                            <button class="main_btn mr10" @click="openAuditDialog">上架确认</button>
                        </div>
                    </div>
                </div>
            </div>
            <el-dialog title="上架确认" :visible.sync="showAuditDialog" width="340px" :close-on-click-modal="false" center>
                <div class="">
...
<@override name="js">
    ...
    <script type="text/babel" src="${cdn}/js/mall/goodsAudit.js?ver=${ver!}"></script>
</@override>
