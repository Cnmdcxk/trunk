(function(win){
    ...
    var app = new Vue({
        ...
        methods:{
            ...
            openReDialog: function(rejectreason,audituser,auditusername){
            ...
            audit: function(){
                ...
                ajax("/api/mall/GoodsListed/batchConfirm/", param, function(json){
                    ...
                    if(_this.rejectOrAgree=="Y"){
                        dialog.success("商品已上架商城", function(){
                            _this.doSearch();
                        });
                    }else {
                        dialog.success("商品上架申请已被驳回", function(){
                            _this.doSearch();
                        });
                    }
            ...
            exportFn("/api/mall/GoodsListed/exportConfirm/", _param, "商品上架确认明细导出")
